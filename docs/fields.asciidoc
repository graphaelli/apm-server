...
APM Metrics for correlation with traces and logs
...
Sampled metrics collected from the agent, as counter or gauge types
...
Any number of key,value pairs associated to the sampled metrics.
